    ...
    icons.left.onload = () => {
        ...
        icons.right.onload = () => {
            ...
            icons.down.onload = () => {
                ...
                icons.tap.src = "dot-circle.svg"
            }
            icons.down.src = "chevron-circle-down.svg"
        }
        icons.right.src = "chevron-circle-right.svg"
    }
    icons.left.src = "chevron-circle-left.svg"
}
icons.up.src = "chevron-circle-up.svg"